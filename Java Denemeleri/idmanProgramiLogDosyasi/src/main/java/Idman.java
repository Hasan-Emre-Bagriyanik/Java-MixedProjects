    ...
    public void purbeeYapti(int sayi){
     ...
     public void pushupYapti(int sayi){
        ...
        if(pushup_sayisi == 0){
            ...
            System.out.println("Yapılacak pushup sayısından daha fazla yaptınız. Tebrikler...");
            pushup_sayisi = 0;
      ...
      public void situpYapti(int sayi){
        ...
        if(situp_sayisi == 0){
            ...
            System.out.println("Yapılacak situp sayısından daha fazla yaptınız. Tebrikler...");
            situp_sayisi = 0;
            System.out.println("Kalan situp sayısı: " + purbee_sayisi);
        }
        else{
            situp_sayisi -= sayi;
       ...
       public void squatYapti(int sayi){
        ...
        if(squat_sayisi == 0){
            ...
            System.out.println("Yapılacak squat sayısından daha fazla yaptınız. Tebrikler...");
            squat_sayisi = 0;
